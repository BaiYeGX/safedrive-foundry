"""Real SimLingo DrivingModel load and bf16 nominal forward.
...
class NeuralForwardResult:
    ...
    # A diagnostic finite-difference series may contain ten samples.
